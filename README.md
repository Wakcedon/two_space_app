...
> ⚠️ ПРЕДУПРЕЖДЕНИЕ: TwoSpace находится в стадии активной разработки (альфа-версия). 
Не используйте для передачи конфиденциальной информации, финансовых данных и подобной чувствительной информации.
